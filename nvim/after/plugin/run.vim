...
autocmd BufEnter *.cpp nnoremap <leader>r
    \ :FloatermSend cd %:p:h ; g++ -std=c++17 %:t -o %:t:r ; ./%:t:r ; rm ./%:t:r<enter>:FloatermToggle<enter>

autocmd BufEnter *.cpp nnoremap <leader>R
    \ :FloatermSend cd %:p:h ; ./run<enter>:FloatermToggle<enter>

autocmd BufEnter *.cs nnoremap <leader>r
    \ :FloatermSend cd %:p:h ; mcs %:t ; mono *.exe ; rm *.exe <enter>:FloatermToggle<enter>
...
autocmd BufEnter *.md nnoremap <leader>R
    \ :FloatermSend! cd %:p:h ; markmap -w %:t<enter>

autocmd BufEnter *.js nnoremap <leader>r
    \ :FloatermSend cd %:p:h ; deno run %:t<enter>:FloatermToggle<enter>

autocmd BufEnter *.ts nnoremap <leader>r
    \ :FloatermSend cd %:p:h ; deno run %:t<enter>:FloatermToggle<enter>

autocmd BufEnter *.go nnoremap <leader>r
    \ :FloatermSend cd %:p:h ; go run %:t<enter>:FloatermToggle<enter>

autocmd BufEnter *.rb nnoremap <leader>r
    \ :FloatermSend cd %:p:h ; ruby %:t<enter>:FloatermToggle<enter>

autocmd BufEnter *.sh nnoremap <leader>r
    \ :FloatermSend cd %:p:h ; chmod +x ./%:t  ; ./%:t <enter>:FloatermToggle<enter>
...
autocmd BufEnter *.wl nnoremap <leader>r
    \ :FloatermSend cd %:p:h ; wolframscript -file %:t<enter>:FloatermToggle<enter>
