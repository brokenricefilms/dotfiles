...
:t() { browser "https://translate.google.com/?source=osdd#auto|auto|$argv" }

:y() { browser "https://www.youtube.com/results?search_query=$argv" }

:d() { browser "https://duckduckgo.com/?q=$argv" }

:gm() { browser "https://www.google.com/maps?q=$argv" }

:g() { browser "https://www.google.com/search?q=$argv" }

:gh() { browser "https://github.com/search?q=$argv" }

:f() { browser "https://www.facebook.com/search?q=$argv" }
