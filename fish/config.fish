...
alias copy_editor_config_file="changeDirectoryTogitRoot ; cp ~/dotfiles/template/skeleton.editorconfig .editorconfig"
...
alias vi="fzfeditFile"
alias vim="fzfeditFile"
alias e="fzfeditFile"
alias e.="nvim ."
