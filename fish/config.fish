...
alias ghhackerrank='cd ~/git/hackerrank ; yo ; push ; cd -'
alias gha='ghdotfiles-termux ; ghstudy ; ghmywebsite ; ghpomodoro ; ghlazyscript ; ghdotfiles ; ghtic_tac_toe ; ghhackerrank'
...
alias glhackerrank='cd ~/git/hackerrank ; pull ; cd -'
alias gla='gldotfiles-termux ; glstudy ; glmywebsite ; glpomodoro; glsherlock ; gldotfiles ; gllazyscript ; gltic_tac_toe ; glhackerrank'
